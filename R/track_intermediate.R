...
#' @param x longitude vector
#' @param y latitude vector
#' @param date optional input date vector
...
#'      mutate(inter = track_intermediate(x, y, date = date, distance = 50000)) %>% unnest()
