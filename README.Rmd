...
There is a huge fragmentation of tools and approaches in R for tracking, see the [moving objects, trajectories](https://cran.r-project.org/web/views/SpatioTemporal.html) section of the Handling and Analyzing Spatio-Temporal DataTask View for examples. 
