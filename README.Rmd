...
There is a huge fragmentation of tools and approaches in R for tracking, see the [moving objects, trajectories](  https://CRAN.R-project.org/view=SpatioTemporal) section of the Handling and Analyzing Spatio-Temporal Data Task View for examples. 
